...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  /// push the named route for the startupScreen.
  onTapStartupScreen() {
    Get.toNamed(
  ...
  /// Navigates to the lSScreen when the action is triggered.

  /// When the action is triggered, this function uses the [Get] package to
  /// push the named route for the lSScreen.
  onTapLS() {
    Get.toNamed(
      AppRoutes.lSScreen,
    );
